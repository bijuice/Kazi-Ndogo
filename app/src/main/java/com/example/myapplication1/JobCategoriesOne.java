...
public class JobCategoriesOne extends AppCompatActivity {
...
//this is for carpentry
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        databaseReference=FirebaseDatabase.getInstance().getReference("Carpentry");
        arrayAdapter=new ArrayAdapter<>(JobCategoriesOne.this, android.R.layout.simple_list_item_1, arrayList);
        ...
        jobcatView_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    Intent intent1= new Intent(view.getContext(), Job_ListingOne.class);
