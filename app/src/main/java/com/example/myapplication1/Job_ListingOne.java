...
public class Job_ListingOne extends AppCompatActivity {
...
//this is for carpentry
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // jobIDview = findViewById(R.id.jobIDview);
        ...
        DocumentReference documentReference = firestore.collection("Carpentry").document("five");
    ...
    public void goprevious(){
        Intent intent= new Intent(this, JobCategoriesOne.class);
