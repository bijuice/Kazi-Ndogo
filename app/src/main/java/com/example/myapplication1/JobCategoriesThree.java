...
public class JobCategoriesThree extends AppCompatActivity {
...
//this is for education
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        arrayAdapter=new ArrayAdapter<>(JobCategoriesThree.this, android.R.layout.simple_list_item_1, arrayList);
        ...
        jobcatView_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    Intent intent1= new Intent(view.getContext(), Job_ListingThree.class);
